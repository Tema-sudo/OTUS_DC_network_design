...
#### 4. Демонстрация работы настроек протокола IS-IS
...
Instance  VRF      System Id        Type Interface          SNPA              State Hold time   Circuit Id
OTUS      default  Spine-1          L2   Ethernet1          P2P               UP    28          0F
OTUS      default  Spine-2          L2   Ethernet2          P2P               UP    24          10
Leaf-2#
```
...
Codes: C - connected, S - static, K - kernel,
 ...
 I L2   10.1.0.1/32 [115/20] via 10.1.5.2, Ethernet1
 I L2   10.1.0.2/32 [115/20] via 10.1.5.8, Ethernet2
 I L2   10.1.1.1/32 [115/30] via 10.1.5.2, Ethernet1
                             via 10.1.5.8, Ethernet2
 I L2   10.1.1.3/32 [115/30] via 10.1.5.2, Ethernet1
                             via 10.1.5.8, Ethernet2
 I L2   10.1.5.0/31 [115/20] via 10.1.5.2, Ethernet1
 I L2   10.1.5.4/31 [115/20] via 10.1.5.2, Ethernet1
 I L2   10.1.5.6/31 [115/20] via 10.1.5.8, Ethernet2
 I L2   10.1.5.10/31 [115/20] via 10.1.5.8, Ethernet2
...
IS-IS Instance: OTUS VRF: default
  IS-IS Level 2 Link State Database
    LSPID                 Seq Num   Cksum  Life  IS Flags
    Spine-1.00-00         147       41255  552   L2 <>
    Spine-2.00-00         152       17240  1018  L2 <>
    Leaf-1.00-00          142       46126  462   L2 <>
    Leaf-2.00-00          142       29029  768   L2 <>
    Leaf-3.00-00          142       9127   913   L2 <>
Leaf-2#
```

```
Leaf-2#show isis database level-2

IS-IS Instance: OTUS VRF: default
  IS-IS Level 2 Link State Database
    LSPID                 Seq Num   Cksum  Life  IS Flags
    Spine-1.00-00         147       41255  547   L2 <>
    Spine-2.00-00         152       17240  1013  L2 <>
    Leaf-1.00-00          142       46126  457   L2 <>
    Leaf-2.00-00          142       29029  763   L2 <>
    Leaf-3.00-00          142       9127   908   L2 <>
Leaf-2#
```
...
DstAddr     MyDisc   YourDisc      Interface    Type          LastUp  LastDown
-------- --------- ----------- -------------- ------- --------------- ---------
10.1.5.2 893035205  675853340  Ethernet1(15)  normal  06/16/23 12:21        NA
10.1.5.8 481353156 4198001555  Ethernet2(16)  normal  06/16/23 12:21        NA
...
Instance  VRF      System Id        Type Interface          SNPA              State Hold time   Circuit Id
OTUS      default  Spine-1          L2   Ethernet1          P2P               UP    25          0F
OTUS      default  Spine-2          L2   Ethernet2          P2P               UP    27          10
Leaf-3#
```
...
Codes: C - connected, S - static, K - kernel,
 ...
 I L2   10.1.0.1/32 [115/20] via 10.1.5.4, Ethernet1
 I L2   10.1.0.2/32 [115/20] via 10.1.5.10, Ethernet2
 I L2   10.1.1.1/32 [115/30] via 10.1.5.4, Ethernet1
                             via 10.1.5.10, Ethernet2
 I L2   10.1.1.2/32 [115/30] via 10.1.5.4, Ethernet1
                             via 10.1.5.10, Ethernet2
 I L2   10.1.5.0/31 [115/20] via 10.1.5.4, Ethernet1
 I L2   10.1.5.2/31 [115/20] via 10.1.5.4, Ethernet1
 I L2   10.1.5.6/31 [115/20] via 10.1.5.10, Ethernet2
 I L2   10.1.5.8/31 [115/20] via 10.1.5.10, Ethernet2
...
IS-IS Instance: OTUS VRF: default
  IS-IS Level 2 Link State Database
    LSPID                 Seq Num   Cksum  Life  IS Flags
    Spine-1.00-00         147       41255  392   L2 <>
    Spine-2.00-00         152       17240  857   L2 <>
    Leaf-1.00-00          143       45615  1198  L2 <>
    Leaf-2.00-00          142       29029  605   L2 <>
    Leaf-3.00-00          142       9127   755   L2 <>
Leaf-3#
```

```
Leaf-3#show isis database level-2

IS-IS Instance: OTUS VRF: default
  IS-IS Level 2 Link State Database
    LSPID                 Seq Num   Cksum  Life  IS Flags
    Spine-1.00-00         147       41255  387   L2 <>
    Spine-2.00-00         152       17240  852   L2 <>
    Leaf-1.00-00          143       45615  1193  L2 <>
    Leaf-2.00-00          142       29029  600   L2 <>
    Leaf-3.00-00          142       9127   750   L2 <>
Leaf-3#
```
...
DstAddr       MyDisc   YourDisc     Interface   Type          LastUp  LastDown
--------- ---------- ---------- ------------- ------- --------------- ---------
10.1.5.4  2118370135 2554756874 Ethernet1(15) normal  06/16/23 12:23        NA
10.1.5.10 1272832778 3852585724 Ethernet2(16) normal  06/16/23 12:23        NA
