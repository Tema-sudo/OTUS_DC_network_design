...
Neighbor Status Codes: m - Under maintenance
  Neighbor         V  AS           MsgRcvd   MsgSent  InQ OutQ  Up/Down State  PfxRcd PfxAcc
  10.1.5.4         4  65000           1737      1737    0    0 23:27:56 Estab  3      3
  10.1.5.10        4  65000           1738      1743    0    0 23:27:55 Estab  3      3
Leaf-3#
```
...
DstAddr       MyDisc   YourDisc     Interface   Type          LastUp  LastDown
--------- ---------- ---------- ------------- ------- --------------- ---------
10.1.5.4  4143689526 2887977675 Ethernet1(15) normal  06/22/23 12:43        NA
10.1.5.10 2606567882  524916101 Ethernet2(16) normal  06/22/23 12:44        NA
...
AS Path Attributes: Or-ID - Originator ID, C-LST - Cluster List, LL Nexthop - Link Local Nexthop
        ...
        Network                Next Hop              Metric  LocPref Weight  Path
 * >    10.1.0.1/32            10.1.5.4              0       100     0       65000 i
 * >    10.1.0.2/32            10.1.5.10             0       100     0       65000 i
 * >Ec  10.1.1.1/32            10.1.5.4              0       100     0       65000 65001 i
 *  ec  10.1.1.1/32            10.1.5.10             0       100     0       65000 65001 i
 * >Ec  10.1.1.2/32            10.1.5.4              0       100     0       65000 65002 i
 *  ec  10.1.1.2/32            10.1.5.10             0       100     0       65000 65002 i
 * >    10.1.1.3/32            -                     0       0       -       i
Leaf-3#
```
...
Gateway of last resort is not set
 ...
 B E    10.1.0.1/32 [200/0] via 10.1.5.4, Ethernet1
 B E    10.1.0.2/32 [200/0] via 10.1.5.10, Ethernet2
 B E    10.1.1.1/32 [200/0] via 10.1.5.4, Ethernet1
                            via 10.1.5.10, Ethernet2
 B E    10.1.1.2/32 [200/0] via 10.1.5.4, Ethernet1
                            via 10.1.5.10, Ethernet2
 C      10.1.1.3/32 is directly connected, Loopback0
 C      10.1.5.4/31 is directly connected, Ethernet1
 C      10.1.5.10/31 is directly connected, Ethernet2
